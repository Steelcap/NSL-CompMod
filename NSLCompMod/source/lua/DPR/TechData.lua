...
function BuildTechData()
    ...
    local techData = {
        ...
        { [kTechDataId] = kTechId.MedPack,    [kTechDataCooldown] = kMedPackCooldown,         [kTechDataAllowStacking] = true, [kTechDataIgnorePathingMesh] = true, [kTechDataMapName] = MedPack.kMapName,   [kTechDataDisplayName] = "MED_PACK",     [kTechDataCostKey] = kMedPackCost,             [kTechDataModel] = MedPack.kModelName,  [kTechDataTooltipInfo] = "MED_PACK_TOOLTIP", [kTechDataSpawnHeightOffset] = kCommanderDropSpawnHeight, [kCommanderSelectRadius] = 0.01, [kTechDataOverrideCoordsMethod] = AlignDroppack },
        { [kTechDataId] = kTechId.CatPack,               [kTechDataAllowStacking] = true, [kTechDataIgnorePathingMesh] = true, [kTechDataMapName] = CatPack.kMapName,   [kTechDataDisplayName] = "CAT_PACK",      [kTechDataCostKey] = kCatPackCost,             [kTechDataModel] = CatPack.kModelName,  [kTechDataTooltipInfo] = "CAT_PACK_TOOLTIP", [kTechDataSpawnHeightOffset] = kCommanderDropSpawnHeight, [kTechDataOverrideCoordsMethod] = AlignDroppack },
        ...
        { [kTechDataId] = kTechId.HeavyMachineGun,      [kTechDataMaxHealth] = kMarineWeaponHealth, [kTechDataTooltipInfo] = "HEAVY_MACHINE_GUN_TOOLTIP", [kTechDataPointValue] = kHeavyMachineGunPointValue,    [kTechDataMapName] = HeavyMachineGun.kMapName,     [kTechDataDisplayName] = "HEAVY_MACHINE_GUN",         [kTechDataModel] = HeavyMachineGun.kModelName, [kTechDataDamageType] = kHeavyMachineGunDamageType, [kTechDataCostKey] = kHeavyMachineGunCost, },
        ...
        { [kTechDataId] = kTechId.ClusterGrenadeProjectile, [kTechDataDamageType] = kClusterGrenadeDamageType,  [kTechDataMapName] = ClusterGrenade.kMapName,   [kTechDataDisplayName] = "CLUSTER_GRENADE", [kTechDataTooltipInfo] =  "CLUSTER_GRENADE_TOOLTIP" },
		{ [kTechDataId] = kTechId.ClusterGrenadeProjectile, [kTechDataDamageType] = kClusterGrenadeDamageType,  [kTechDataMapName] = ClusterFragment.kMapName,   [kTechDataDisplayName] = "CLUSTER_GRENADE", [kTechDataTooltipInfo] =  "CLUSTER_GRENADE_TOOLTIP" },
		
        { [kTechDataId] = kTechId.GasGrenadeProjectile, [kTechDataDamageType] = kNerveGasDamageType,  [kTechDataMapName] = GasGrenade.kMapName,   [kTechDataDisplayName] = "GAS_GRENADE", [kTechDataTooltipInfo] =  "GAS_GRENADE_TOOLTIP" },
        { [kTechDataId] = kTechId.PulseGrenadeProjectile,  [kTechDataDamageType] = kPulseGrenadeDamageType, [kTechDataMapName] = PulseGrenade.kMapName,   [kTechDataDisplayName] = "PULSE_GRENADE", [kTechDataTooltipInfo] =  "PULSE_GRENADE_TOOLTIP" },
        ...
        { [kTechDataId] = kTechId.HeavyMachineGunTech,      [kTechDataCostKey] = kHeavyMachineGunTechResearchCost,      [kTechDataResearchTimeKey] = kHeavyMachineGunTechResearchTime, [kTechDataDisplayName] = "RESEARCH_HEAVY_MACHINE_GUN", [kTechDataTooltipInfo] = "HEAVY_MACHINE_GUN_TOOLTIP"},
...
function LookupTechData(techId, fieldName, default)
    ...
    if fieldName == kTechDataUpgradeCost or fieldName == kTechDataCostKey then
        if GetGameInfoEntity and GetGameInfoEntity() and GetGameInfoEntity():GetWarmUpActive() then return 0 end
    end
