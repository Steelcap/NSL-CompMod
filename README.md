...
### 2018-4-10 -- Merged Beta Mod for Season 13
...
* Hallucinated players don't ragdoll on death
* Swapping upgrades increases gestation time by 1 second per upgrade swapped
...
* Cluster Grenades set structures and players on fire for four seconds
* Cluster Grenades destroy ability clouds (bile, spores, umbra)
...
* Discarded weapon lifetime decreased to 22s from 25
...
* Hand Grenade research time decreased to 15s from 45s
* **Cluster Grenades set structures and players on fire for four seconds**
* **Cluster Grenades destroy ability clouds (bile, spores, umbra, enzyme, mucous)**
* Removed PowerSurge research, PowerSurge now requires powered Robotics Factory 
* Removed secondary effects of PowerSurge (Damage and AttackSlow)  
* Reduced cost of PowerSurge from 5 to 3  
* Commander Jetpack drop cost increased to 20 from 15  
...
* **Catalyst pack effect duration decreased to 8 from 12**
