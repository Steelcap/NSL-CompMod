...
Each update snapshots all changes from vanilla to CompMod. **Bold indicates latest change**
...
* **Medpack Pickup delay from .45 to .5**
...
* Babbler HP to 11
* **Added Neurotoxin to replace Focus**
* **Neurotoxin deals 4 damage per second per stack (6 for fade and 2 for lerk)**
